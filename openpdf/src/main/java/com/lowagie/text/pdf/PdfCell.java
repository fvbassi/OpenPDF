...
import com.lowagie.text.ComposedElement;
...
public class PdfCell extends Rectangle {
                ...
                default:
                    ...
                    if (chunks.isEmpty()) {
                       ...
                       line = new PdfLine(currentLeft, currentRight, alignment, currentLineLeading);
                        ...
                        for (Chunk c : chunks) {
                            PdfChunk chunk = new PdfChunk(c, allActions.get(aCounter++));
                            PdfChunk overflow;
    ...
    private void addList(List list, float left, float right, int alignment) {
        ArrayList<PdfAction> allActions = new ArrayList<>();
    ...
    public ArrayList<PdfLine> getLines(float top, float bottom) {
        ...
        ArrayList<PdfLine> result = new ArrayList<>();
