    ...
    protected void write(Element element, int indent) throws IOException {
        ...
        switch(element.type()) {
            ...
            case Element.PHRASE:
            {
                ...
                // contents
                for(Element el : phrase.getChildren()) {
                    write(el, indent + 1);
                }
                // end tag
                addTabs(indent);
            ...
            case Element.ANCHOR:
            {
                ...
                // contents
                for(Element el : anchor.getChildren()) {
                    write(el, indent + 1);
                }
                // end tag
                addTabs(indent);
            ...
            case Element.PARAGRAPH:
            {
                ...
                // contents
                for(Element el : paragraph.getChildren()) {
                    write(el, indent + 1);
                }
                // end tag
                addTabs(indent);
            ...
            case Element.LISTITEM:
            {
                ...
                // contents
                for(Element el : listItem.getChildren()) {
                    write(el, indent + 1);
                }
                // end tag
                addTabs(indent);
            ...
            case Element.CELL:
            {
                ...
                if (cell.isEmpty()) {
                    ...
                    for(Element el : cell.getChildren()) {
                        write(el, indent + 1);
                    }
                }
                // end tag
 ...
 */
    ...
    protected void writeSection(Section section, int indent) throws IOException {
        if (section.getTitle() != null) {
            ...
            // contents
            for(Element el : section.getChildren()) {
                write(el, indent + 1);
            }
            // end tag
            addTabs(indent);
